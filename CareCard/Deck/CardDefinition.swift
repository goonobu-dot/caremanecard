...
public enum Subject: String, Sendable, CaseIterable, Identifiable {
    case shien      // ①介護支援分野
    case hoken      // ②保健医療サービス分野
    case fukushi    // ③福祉サービス分野

    public var id: String { rawValue }

    public var displayName: String {
        switch self {
        case .shien: return "介護支援分野"
        case .hoken: return "保健医療サービス分野"
        case .fukushi: return "福祉サービス分野"
        }
    }
    ...
    public init?(deckValue raw: String) {
        switch raw {
        case "shien", "介護支援分野", "介護支援":
            self = .shien
        case "hoken", "保健医療サービス分野", "保健医療サービス", "保健医療":
            self = .hoken
        case "fukushi", "福祉サービス分野", "福祉サービス":
            self = .fukushi
        default:
            return nil
        }

...
final class AppSettingsStore {
    ...
    private static let examDateKey = "caremane.examDate"
    private static let studiedTodayCountKey = "caremane.studiedTodayCount"
    private static let studiedTodayDateKey = "caremane.studiedTodayDate"
    private static let streakCountKey = "caremane.streakCount"
    private static let lastStudyDateKey = "caremane.lastStudyDate"
